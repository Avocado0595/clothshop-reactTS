...
export default function SignUp() {
    ...
    <div className='sign-in'>
        ...
        <Input label='Display name' type='text' name='name' required={true}/>
            <Input label='Email' type='email' name='emailSignUp' required={true}/>
            <Input label='Password' type='password' name='passwordSignUp' required={true}/>
            <Input label='Confirm password' type='password' name='confirmPassword' required={true}/>
